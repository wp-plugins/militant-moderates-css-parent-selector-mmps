<?php
/**
 * @package mmParentSelector
 * @version 1.0.0
 */
/*
Plugin Name: Militant Moderates CSS Parent Selector
...
Author URI: https://en.gravatar.com/mmtechmaster
...
function mmps_js() {
	...
	if ( file_exists( plugin_dir_path( __FILE__ ) . 'css/mmParentSelector.css' ) )
